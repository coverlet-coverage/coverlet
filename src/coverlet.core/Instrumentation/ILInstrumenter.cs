...
namespace Coverlet.Core.Instrumentation
{
    internal class ILInstrumenter
    {
        ...
        public ILInstrumenter(string module, string identifier, string[] excludeFilters, string[] includeFilters, string[] excludedFiles, string[] excludedAttributes, bool singleHit, ILogger logger)
        {
            _module = module;
        ...
        private Instruction AddInstrumentationCode(MethodDefinition method, ILProcessor processor, Instruction instruction, SequencePoint sequencePoint)
        {
            ...
            var entry = new HitCandidate(false, document.Index, sequencePoint.StartLine, sequencePoint.EndLine);
        ...
        private Instruction AddInstrumentationCode(MethodDefinition method, ILProcessor processor, Instruction instruction, BranchPoint branchPoint)
        {
            ...
            var entry = new HitCandidate(true, document.Index, branchPoint.StartLine, (int)branchPoint.Ordinal);
            _result.HitCandidates.Add(entry);
