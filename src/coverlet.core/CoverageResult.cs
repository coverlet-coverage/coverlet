                                ...
                                else
                                {
                                    foreach (var method in @class.Value)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            foreach (var branch in this.Modules[module.Key][document.Key][@class.Key][method.Key].Branches)
                                            {
                                                //if one branch is covered we search the other one only if it's not covered
                                                if (CecilSymbolHelper.IsMoveNext(method.Key) && branch.Hits > 0)
                                                {
                                                    foreach (var moveNextBranch in this.Modules[module.Key][document.Key][@class.Key][method.Key].Branches)
                                                    {
                                            ...
                                            {
                                                this.Modules[module.Key][document.Key][@class.Key][method.Key].Branches.Remove(branchToRemove);
                                            }
                                        }
                                    }
                                }
