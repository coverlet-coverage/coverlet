...
- Fix [BUG] Coverlet.Collector produces empty report when Mediator.SourceGenerator is referenced [#1718](https://github.com/coverlet-coverage/coverlet/issues/1718)
- Fix [BUG] Crash during instrumentation (native code assemblies) [1762](https://github.com/coverlet-coverage/coverlet/issues/1762)
