...
| ExcludeByAttribute              | Exclude a method, an entire class or assembly from code coverage decorated by an attribute. <br>_Default is_ none.                                             |
| ExcludeByFile                   | Ignore specific source files from code coverage. <br>_Default is_ none.                                                                                        |
| Include                         | Explicitly set what to include in code coverage analysis using filter expressions. <br>_Default is_ none (all assemblies included).                             |
...
| DoesNotReturnAttribute          | Methods marked with these attributes are known not to return, statements following them will be excluded from coverage. <br>_Default is_ none.                  |
