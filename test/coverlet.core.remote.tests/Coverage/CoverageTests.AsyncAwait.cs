...
namespace coverlet.core.remote.tests
{
  public partial class CoverageTests
  {
    ...
    //readonly ProcessStartInfo _startInfo = new() { UseShellExecute = false, RedirectStandardOutput = true, WorkingDirectory = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) };
    ...
    public void AsyncAwait_Issue_1177()
    {
      ...
      try
      {
        ...
        Coverlet.Core.Instrumentation.Document document = TestInstrumentationHelper.GetCoverageResult(path).Document("Instrumentation.AsyncAwait.cs");
