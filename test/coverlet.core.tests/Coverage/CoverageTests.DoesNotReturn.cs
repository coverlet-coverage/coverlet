...
namespace Coverlet.Core.Tests
{
  public partial class CoverageTests
  {
    ...
    [Fact]
    public async Task NoBranches_DoesNotReturnAttribute_InstrumentsCorrectAsync()
    {
    ...
    public async Task If_DoesNotReturnAttribute_InstrumentsCorrectAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact(Skip = "Hang due to System.Console.ReadKey()")]
    public async Task Switch_DoesNotReturnAttribute_InstrumentsCorrectAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact(Skip = "Hang due to System.Console.ReadKey()")]
    public async Task Subtle_DoesNotReturnAttribute_InstrumentsCorrectAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact]
    public async Task CallsGenericMethodDoesNotReturn_DoesNotReturnAttribute_InstrumentsCorrectAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact]
    public async Task CallsGenericClassDoesNotReturn_DoesNotReturnAttribute_InstrumentsCorrectAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact]
    public async Task WithLeave_DoesNotReturnAttribute_InstrumentsCorrectAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact]
    public async Task FiltersAndFinallies_DoesNotReturnAttribute_InstrumentsCorrectAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
