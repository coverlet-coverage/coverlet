...
namespace Coverlet.Core.Tests
{
  ...
  {
    [Fact]
    public async Task SelectionStatements_If()
    {
    ...
    [Fact]
    public async Task SelectionStatements_Switch()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact]
    public async Task SelectionStatements_Switch_CSharp8_OneBranch()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact]
    public async Task SelectionStatements_Switch_CSharp8_AllBranches()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
