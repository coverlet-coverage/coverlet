  ...
  public partial class CoverageTests
  {
    ...
    public async Task AsyncAwaitAsync()
    {
      ...
      try
      {
        ...
        CoveragePrepareResult result = await TestInstrumentationHelper.Run<AsyncAwait>(async instance =>
                  {
    ...
    public async Task AsyncAwait_Issue_669_1Async()
    {
      ...
      try
      {
        CoveragePrepareResult result = await TestInstrumentationHelper.Run<Issue_669_1>(async instance =>
                {
    ...
    [Fact (Skip ="execution with CLI fails; Visual Studio success")]
