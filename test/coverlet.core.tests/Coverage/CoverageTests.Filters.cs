    ...
    public partial class CoverageTests
    {
        ...
        public void ExcludeFilteredNestedAutogeneratedTypes()
        {
            ...
            try
            {
                ...
                {
                    _ = await TestInstrumentationHelper.Run<ExcludeFilterNestedAutogeneratedTypes>(instance =>
                    {
                        instance.Run();
        ...
        public void ExcludeFilteredTypes()
        {
            ...
            try
            {
                FunctionExecutor.Run(async (string[] pathSerialize) =>
                {
                    _ = await TestInstrumentationHelper.Run<ExcludeFilterOuterTypes>(instance =>
                    {
        ...
        public void ExcludeFilteredNestedTypes()
        {
            ...
            try
            {
                FunctionExecutor.Run(async (string[] pathSerialize) =>
                {
                    _ = await TestInstrumentationHelper.Run<ExcludeFilterClass1>(instance =>
                    {
                        Assert.Equal(42, instance.Run());
                        return Task.CompletedTask;
                    },
