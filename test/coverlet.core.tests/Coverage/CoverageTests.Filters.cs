...
namespace Coverlet.Core.Tests
{
  ...
  {
    [Fact]
    public async Task ExcludeFilteredNestedAutogeneratedTypesAsync()
    {
    ...
    [Fact]
    public async Task ExcludeFilteredTypesAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
    ...
    [Fact]
    public async Task ExcludeFilteredNestedTypesAsync()
    {
      string path = Path.GetTempFileName();
      string[] pathSerialize = [path];
      try
