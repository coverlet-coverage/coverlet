    ...
    public class CoverletCoverageDataCollectorTests
    {
        ...
        public void OnSessionStartShouldPrepareModulesForCoverage()
        {
            ...
            _coverletCoverageDataCollector.Initialize(
                    ...
                    _context);
            IDictionary<string, object> sessionStartProperties = new Dictionary<string, object>();
            Coverage coverage = new Coverage("abc.dll", null, null, null, null, null, true, true, "abc.json", true, It.IsAny<ILogger>(), (IFileSystem)DependencyInjection.Current.GetService(typeof(IFileSystem)), (IInstrumentationHelper)DependencyInjection.Current.GetService(typeof(IInstrumentationHelper)));
